                    ...
                    <div class="single-footer mb-sm-40">
                        ...
                        <div class="footer-content">
                            <ul class="footer-list address-content">
                                <li><i class="lnr lnr-map-marker"></i> Address: Quy Nhơn, Bình Định.</li>
                                <li><i class="lnr lnr-envelope"></i><a href="mailto:datnguyen8924@gmail.com"> mail Us: Support@BaudaCosmetics.vn </a></li>
                                <li>
                                    <i class="lnr lnr-phone-handset"></i><a href="tel:+84398608924"> Phone:(+84) 398608924) </a>
                                </li>
                            </ul>
    ...
    <div class="footer-bottom pb-30">
        <div class="container">
             ...
             <div class="copyright-text text-center">
                <p>Copyright © 2021 <a target="_blank" href="#">BaudaCosmetics</a> All Rights Reserved.</p>
             </div>
        </div>
        <!-- Container End -->
    </div>
