...
@section('content-layout')
    ...
    <div class="image-banner pb-50 off-white-bg">
        <div class="container">
            <div class="col-img">
                <a href="http://127.0.0.1:8000/chi-tiet-san-pham-178/tinh-chat-phuc-hoi-chong-lao-hoa-estee-lauder-advanced-night-repair-synchronized-multi-recovery-50ml"><img src="{{ asset('source/assets/frontend/img/banner/h1-banner.jpg') }}"
                        alt="image banner"></a>
            </div>
        </div>
        <!-- Container End -->
        ...
        <div class="container banner-2">
            <div class="banner-box">
                <div class="col-img" style="width: 224px; height: 174.44px">
                    <a href="http://127.0.0.1:8000/loai-san-pham-1"><img width="224px" height="174.44px"
