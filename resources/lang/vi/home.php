...
return [
	...
	'producttt' => 'Sản Phẩm',
	'contact' => 'Liên Hệ',
	'address' => '450 Lê Văn Việt',
	'carttt' => 'Giỏ Hàng',
	'empty' => 'Trống',


	'signup' => 'Đăng Ký',
	'signup_nd' => 'Bằng cách tạo tài khoản, bạn sẽ có thể mua sắm nhanh hơn, cập nhật trạng thái đơn hàng và theo dõi các đơn hàng bạn đã thực hiện trước đó.',
	'signup_nd1' => 'Nếu bạn đã có tài khoản với chúng tôi, vui lòng đăng nhập tại trang đăng nhập.',
	'signup_nd2' => 'Thông tin cá nhân của bạn',
	'signup_nd3' => 'Mật khẩu của bạn',
	'signin' => 'Đăng Nhập',
	'continue' => 'Tiếp tục',
	'account' => 'Tài khoản',
	'brand' => 'Thương hiệu',
	...
	'freeship' => 'Giao hàng miễn phí cho đơn hàng trên 1 triệu',
	...
	'ghichu' => 'Ghi Chú',
	'ghichunoidung' => 'Ghi chú về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt khi giao hàng.',
	'BillingDetails' => 'Chi Tiết Thanh Toán',
	'male' => 'Nam',
	'female' => 'Nữ',
	'YOURORDER' => 'ĐƠN HÀNG CỦA BẠN',
	'noidungpay' => 'Cửa hàng sẽ gửi hàng đến địa chỉ của bạn, bạn xem hàng rồi thanh toán tiền cho nhân viên giao hàng.',

	//dang xuat
	'logout' => 'Đăng xuất',
	'logout_1' => 'Bạn muốn đăng xuất?',
	'logout_2' => 'Chọn "Đăng xuất" bên dưới nếu bạn đã chắc chắn thoát.',
	'cancel' => 'Hủy bỏ',
	'up_date' => 'Cập nhật',
