...
/*-----------------------------------------------Đơn-Hàng----------------------------------------------------------------*/
    ...
    public function print_order_convert($checkout_code){
        ...
        <div style="float: left; margin: 0 0 1.5em 0; ">
         <strong style="font-size: 18px;">BaudaCosmetics</strong>
          <br />
          <strong>Địa chỉ:</strong> Quy Nhơn, Bình Định.
          <br/>
          <strong>Điện thoại:</strong> 0398608924
          <br/>
          <strong>Website:</strong> BaudaCosmetics.demo
          <br/>
          <strong>Email:</strong> datnguyen8924@gmail.com
        </div>
        ...
        </td></tr></table><br/><br/><br/><p>Nếu bạn có thắc mắc, vui lòng liên hệ chúng tôi qua email <u>datnguyen8924@gmail.com</u> hoặc 0398608924</p></div>
        ';
